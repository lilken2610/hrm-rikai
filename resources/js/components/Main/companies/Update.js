...
class UpdateCompany extends Component{
    ...
    componentDidMount() {
        axios
            .get("http://127.0.0.1:8000/api/auth/detail-company/" + this.props.match.params.id)
            .then(res => {
                ...
                this.setState({
                    ...
                    newData: {
                        ...
                        companyDescription: res.data.description
                    },
                    fields: {
                        companyName: res.data.name,
                        companyDescription: res.data.description
    ...
    handleCreate = (event) => {
        ...
        if (this.handleValidation() === true) {
            ...
            axios.put('http://127.0.0.1:8000/api/auth/detail-company/'+this.props.match.params.id+'/edit', newCompany)
                .then(res => {
                    this.setState({
                        message_error_server: true
                    });
            ...
            <div className="right_col" role="main" style={{ minHeight: '1000px' }}>
                    ...
                    <div className="col-md-12 col-sm-12 ">
                        <div className="x_panel">
                            <div className="x_title">
                                <h2>
                                    <Link to={'/'}>Home Page / </Link><Link to={'/companies'}>List Companies / </Link><Link to={'/detail-company' + this.state.company.id + "/edit"}>Update Company</Link></h2>
                ...
                <span className="required">*</span>
                                        ...
                                        <div className="col-md-6 col-sm-6 ">
                                            <input type="text" className="form-control " defaultValue={this.state.company.name} name="companyName" onChange={(event) => { this.handleChange(event) }} maxLength={255} />
                ...
                <span className="required">*</span>
                                        ...
                                        <div className="col-md-6 col-sm-6 ">
                                            <textarea className="form-control " name="companyDescription" onChange={(event) => { this.handleChange(event) }} rows={8} maxLength={10000} defaultValue={this.state.company.description} />
                                            <span className="error" style={{ color: "red", fontSize: 16 }}>
                                                {
                                                    this.state.error_client[
                                                    "companyDescription"
                                    ...
                                    <div className="item form-group">
                                        <div className="col-md-6 col-sm-6 offset-md-3">
                                            <Link to={'/companies'}><button className="btn btn-info" type="button">Cancel</button></Link>
